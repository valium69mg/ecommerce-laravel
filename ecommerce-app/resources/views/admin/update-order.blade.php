        ...
        <div class="main-panel">
          ...
          @if(session()->has('message'))
            <div class="alert alert-success">
              ...
              <a href="/storeOrders"> back to orders </a>
            </div>
            @endif
            <div class="divCenter">
                <h2 class="h2font"> Update Order Status </h2>
                
                <form action="{{'/updateOrderStatus/'.$order->id}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="addProductForm">
                        <div class="category">
                        <label for="category"> Payment Status </label>
                        <select class="text_color" name="payment_status" >
                        ...
                        <div class="category">
                        <label for="category"> Delivery Status </label>
                        <select class="text_color" name="delivery_status">
